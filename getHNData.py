#This file is reponsible for getting all the HN data and placing it in hn_event_table
...
try:
	for row in cur.fetchall():
		...
		while True:
			try:
				hn_incrementor += 1
				hn_search_url = 'https://hn.algolia.io/api/v1/search_by_date?query=\"https://github.com/' + row[0] + '\"&page=' + str(hn_incrementor)
				print hn_search_url
