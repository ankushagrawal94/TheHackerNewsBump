...
#cursor.execute("DROP TABLE IF EXISTS event_table_two")
#cursor.execute ("""
	        ...
	        for dd in range(1,32):
	            for hh in range(0,24):
	                ...
	                if len(strMM) == 1:
	                    strMM = "0" + strMM
	                    processedFiles += 1
	                print "20" + strYY + "-" + strMM + "-" + strDD + "-" + strHH + "\t" + "count is: " + str(counter) + "\tsuccesful entries is: " + str(good) + "\tProcessed Files is: " + str(processedFiles) + "\tElapsed Time: %s seconds" % int(time.time() - start_time)
	                try:
	                    ...
	                    for each_event in f:
	                        if(each_event["type"] == "WatchEvent"):
	                            try:
	                                ...
	                                repo_created = each_event["repository"]["created_at"][:10]
